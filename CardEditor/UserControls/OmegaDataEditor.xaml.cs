...
{
    /// <summary>
    /// Interaction logic for OmegaDataEditor.xaml
    /// </summary>
    public partial class OmegaDataEditor : UserControl, INotifyPropertyChanged, IDisposable, ISaveable
    {
        #region Variable
        ...
        public OmegaDataEditor(IMainWindowService service) : this()
        {
